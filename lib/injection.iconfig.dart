...
import 'package:e_coupon/data/lib/mock_library.dart';
...
void $initGetIt(GetIt g, {String environment}) {
  g.registerLazySingleton<ILibWalletSource>(() => LibWalletSource());
  ...
  g.registerLazySingleton<GetVerificationInputs>(
